...
namespace UnityRoyale
{
    public class GameManager : MonoBehaviour
    {
        ...
        public void OnWinCutsceneOver()
        {
            UIManager.ShowWinGameUI();
        }
        ...
        private void OnPlaceableDead(Placeable p)
        {
            ...
            switch(p.pType)
            {
                ...
                case Placeable.PlaceableType.Castle:
                    if (p.teamColor == Placeable.TeamColor.Red)
                    {
                        ...
                        Debug.Log("Red");
                        OnEndGameCutsceneOver();
                    }
                    else if (p.teamColor == Placeable.TeamColor.Blue)
                    {
                        Building b = (Building)p;
                        RemovePlaceableFromList(b);
                        UIManager.RemoveHealthUI(b);
